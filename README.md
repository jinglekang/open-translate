...
整页翻译会收集当前页面最多 180 个可见文本节点并分批翻译。弹窗中的整页翻译范围可在“可见页面”和“当前视窗”之间切换；当前视窗模式会优先翻译屏幕内文本，并在滚动后继续翻译进入视窗的内容。选择“仅译文”时会替换页面文本，选择“双语对照”时会保留原文并插入译文。翻译完成后再次右键页面可选择“显示原文”取消翻译，刷新页面也会恢复原始页面内容。
